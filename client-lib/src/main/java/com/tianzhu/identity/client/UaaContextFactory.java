...
package com.tianzhu.identity.client;
...
import static com.tianzhu.identity.client.token.GrantType.AUTHORIZATION_CODE;
import static com.tianzhu.identity.client.token.GrantType.PASSWORD_WITH_PASSCODE;
...
public class UaaContextFactory {
    ...
    /**
     * Performs a {@link com.tianzhu.identity.client.token.GrantType#PASSWORD authentication}
     * @param tokenRequest - a configured TokenRequest
     * @return an authenticated {@link UaaContext}
     */
     ...
     * 2. If the {@link TokenRequest} is a {@link com.tianzhu.identity.client.token.GrantType#PASSWORD_WITH_PASSCODE}
    ...
    /**
     * Performs a {@link com.tianzhu.identity.client.token.GrantType#CLIENT_CREDENTIALS authentication}
