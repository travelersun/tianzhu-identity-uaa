...
public class ProfileController {
    ...
    @Autowired
    public ProfileController(@Qualifier("approvalStore") ApprovalStore approvalsService,
                             @Qualifier("jdbcClientDetailsService") ClientServicesExtension clientDetailsService) {
