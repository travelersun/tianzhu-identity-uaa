...
import com.tianzhu.identity.uaa.login.AuthenticationResponse;
...
public class RemoteAuthenticationEndpoint {
    ...
    @Autowired
    public RemoteAuthenticationEndpoint(@Qualifier("zoneAwareAuthzAuthenticationManager") AuthenticationManager authenticationManager) {
