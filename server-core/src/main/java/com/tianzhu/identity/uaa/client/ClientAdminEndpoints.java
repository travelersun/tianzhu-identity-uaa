...
import com.tianzhu.identity.uaa.zone.InvalidClientSecretException;
...
public class ClientAdminEndpoints implements InitializingBean, ApplicationEventPublisherAware {
    ...
    @Autowired
    @Qualifier("caSimpleAttributeNameMapper")
    ...
    @Autowired
    @Qualifier("clientDetailsValidator")
    private ClientDetailsValidator clientDetailsValidator;

    @Autowired
    @Qualifier("restrictUaaScopesClientValidator")
