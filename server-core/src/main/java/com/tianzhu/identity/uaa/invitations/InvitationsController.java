...
import com.tianzhu.identity.uaa.account.PasswordConfirmationValidation;
...
import com.tianzhu.identity.uaa.invitations.InvitationsService.AcceptedInvitation;
...
public class InvitationsController {
    ...
    @Autowired
    public InvitationsController(@Qualifier("invitationsService") InvitationsService invitationsService) {
