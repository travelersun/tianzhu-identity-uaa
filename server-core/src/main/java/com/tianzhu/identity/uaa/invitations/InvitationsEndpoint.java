...
import com.tianzhu.identity.uaa.scim.exception.ScimResourceConflictException;
...
import static com.tianzhu.identity.uaa.util.DomainFilter.filter;
...
public class InvitationsEndpoint {
    ...
    @Autowired
    public InvitationsEndpoint(@Qualifier("scimUserProvisioning") ScimUserProvisioning users,
                               @Qualifier("identityProviderProvisioning") IdentityProviderProvisioning providers,
                               @Qualifier("jdbcClientDetailsService") ClientServicesExtension clients,
