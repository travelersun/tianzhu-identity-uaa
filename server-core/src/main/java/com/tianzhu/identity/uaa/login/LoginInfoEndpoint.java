...
import com.tianzhu.identity.uaa.provider.saml.SamlRedirectUtils;
import com.tianzhu.identity.uaa.util.*;
import com.tianzhu.identity.uaa.util.JsonUtils.JsonUtilException;
...
public class LoginInfoEndpoint {
    ...
    @Autowired
    @Qualifier("xoauthProviderConfigurator")
