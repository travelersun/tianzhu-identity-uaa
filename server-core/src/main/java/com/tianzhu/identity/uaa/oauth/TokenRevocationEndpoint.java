...
import com.tianzhu.identity.uaa.oauth.event.TokenRevocationEvent;
...
public class TokenRevocationEndpoint implements ApplicationEventPublisherAware {
    ...
    @Autowired
    public TokenRevocationEndpoint(@Qualifier("jdbcClientDetailsService") MultitenantJdbcClientDetailsService clientDetailsService,
                                   @Qualifier("scimUserProvisioning") ScimUserProvisioning userProvisioning,
