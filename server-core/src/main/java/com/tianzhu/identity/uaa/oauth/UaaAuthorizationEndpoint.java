...
import com.tianzhu.identity.uaa.util.UaaHttpRequestUtils;
...
public class UaaAuthorizationEndpoint extends AbstractEndpoint {
    ...
    private RedirectResolver redirectResolver = new AntPathRedirectResolver();
    ...
    @Autowired
    public UaaAuthorizationEndpoint(@Qualifier("oauth2TokenGranter") TokenGranter tokenGranter,@Qualifier("jdbcClientDetailsService") ClientServicesExtension clientDetailsService,@Qualifier("authorizationRequestManager") OAuth2RequestFactory oAuth2RequestFactory){
