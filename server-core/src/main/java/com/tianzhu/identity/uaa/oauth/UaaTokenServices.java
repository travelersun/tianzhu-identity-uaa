...
import com.tianzhu.identity.uaa.authentication.Origin;
...
import com.tianzhu.identity.uaa.util.TokenValidation;
...
import static com.tianzhu.identity.uaa.oauth.token.ClaimConstants.*;
import static com.tianzhu.identity.uaa.oauth.token.RevocableToken.TokenFormat.JWT;
import static com.tianzhu.identity.uaa.oauth.token.RevocableToken.TokenFormat.OPAQUE;
