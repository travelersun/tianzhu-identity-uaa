...
public class UaaTokenEndpoint extends TokenEndpoint {
    ...
    @Autowired
    public UaaTokenEndpoint(@Qualifier("oauth2RequestValidator") OAuth2RequestValidator oAuth2RequestValidator,
                            @Qualifier("oauth2TokenGranter") TokenGranter tokenGranter,
