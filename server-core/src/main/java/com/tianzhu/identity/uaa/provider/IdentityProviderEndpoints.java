...
import com.tianzhu.identity.uaa.authentication.manager.LdapLoginAuthenticationManager;
import com.tianzhu.identity.uaa.audit.event.EntityDeletedEvent;
...
public class IdentityProviderEndpoints implements ApplicationEventPublisherAware {
    ...
    public IdentityProviderEndpoints(
        @Qualifier("identityProviderProvisioning") IdentityProviderProvisioning identityProviderProvisioning,
        ...
        @Qualifier("metaDataProviders") SamlIdentityProviderConfigurator samlConfigurator,
        @Qualifier("identityProviderConfigValidator") IdentityProviderConfigValidator configValidator) {
