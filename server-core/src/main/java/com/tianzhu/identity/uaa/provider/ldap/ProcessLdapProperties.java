...
import com.tianzhu.identity.uaa.provider.ldap.extension.DefaultTlsDirContextAuthenticationStrategy;
import com.tianzhu.identity.uaa.provider.ldap.extension.ExternalTlsDirContextAuthenticationStrategy;
import com.tianzhu.identity.uaa.security.LdapSocketFactory;
...
public class ProcessLdapProperties {
    ...
    public static final String LDAP_SSL_SOCKET_FACTORY = "com.tianzhu.identity.ldap.ssl.factory.socket";
