...
import com.tianzhu.identity.uaa.web.ExceptionReportHttpMessageConverter;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.tianzhu.identity.uaa.account.UserAccountStatus;
import com.tianzhu.identity.uaa.account.event.UserAccountUnlockedEvent;
...
import com.tianzhu.identity.uaa.resources.*;
import com.tianzhu.identity.uaa.scim.*;
import com.tianzhu.identity.uaa.scim.util.ScimUtils;
import com.tianzhu.identity.uaa.scim.validate.PasswordValidator;
import com.tianzhu.identity.uaa.util.DomainFilter;
...
public class ScimUserEndpoints implements InitializingBean, ApplicationEventPublisherAware {
    ...
    @Autowired
    @Qualifier("groupMembershipManager")
    ...
    public ScimUser createUser(@RequestBody ScimUser user, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!isUaaUser(user)) {
            ...
            if(!idpsForEmailDomain.isEmpty()) {
                ...
                throw new ScimException(String.format("The user account is set up for single sign-on. Please use one of these origin(s) : %s",idpOrigins.toString()), BAD_REQUEST);
            }
    ...
    public SearchResults<?> findUsers(
        ...
        try {
            ...
            throw new ScimException(msg, BAD_REQUEST);
        }
