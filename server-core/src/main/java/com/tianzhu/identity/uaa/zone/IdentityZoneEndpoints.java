...
public class IdentityZoneEndpoints implements ApplicationEventPublisherAware {
    ...
    @Autowired
    @Qualifier("identityZoneValidator")
    private IdentityZoneValidator validator;

    @Autowired
    public IdentityZoneEndpoints(@Qualifier("identityZoneProvisioning") IdentityZoneProvisioning zoneDao, @Qualifier("identityProviderProvisioning") IdentityProviderProvisioning idpDao,
                                 @Qualifier("zoneEndpointsClientRegistrationService") IdentityZoneEndpointClientRegistrationService clientRegistrationService,
