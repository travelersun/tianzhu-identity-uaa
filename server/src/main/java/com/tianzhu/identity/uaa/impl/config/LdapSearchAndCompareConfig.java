...
import com.tianzhu.identity.uaa.provider.ldap.ExtendedLdapUserMapper;
import com.tianzhu.identity.uaa.provider.ldap.PasswordComparisonAuthenticator;
import com.tianzhu.identity.uaa.provider.ldap.ProcessLdapProperties;
...
public class LdapSearchAndCompareConfig {
  ...
  public LdapAuthenticationProvider ldapAuthProvider(BaseLdapPathContextSource contextSource, Environment environment,
    ...
    String passwordEncoderClassName = ofNullable(environment.getProperty("ldap.base.passwordEncoder")).orElse("com.tianzhu.identity.uaa.provider.ldap.DynamicPasswordComparator");
