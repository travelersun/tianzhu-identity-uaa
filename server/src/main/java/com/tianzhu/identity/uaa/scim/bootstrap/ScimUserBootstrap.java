...
import com.tianzhu.identity.uaa.authentication.manager.AuthEvent;
...
import com.tianzhu.identity.uaa.scim.exception.MemberNotFoundException;
...
public class ScimUserBootstrap implements
    ...
    protected ScimUser getScimUser(UaaUser user) {
        ...
        if (users.isEmpty() && hasText(user.getId())) {
            try {
