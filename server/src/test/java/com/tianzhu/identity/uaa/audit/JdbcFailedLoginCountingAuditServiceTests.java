 ...
 *******************************************************************************/
package com.tianzhu.identity.uaa.audit;
...
import static com.tianzhu.identity.uaa.audit.AuditEventType.*;
...
public class JdbcFailedLoginCountingAuditServiceTests extends JdbcTestBase {
    ...
    public void delete_happens_single_thread_on_intervals() throws Exception {
        ...
        verify(template, times(1)).update(queries.capture(), ArgumentMatchers.any(Timestamp.class));
    }
    ...
    public void periodic_delete_works() throws Exception {
        ...
        verify(template, times(1)).update(ArgumentMatchers.anyString(), ArgumentMatchers.any(Timestamp.class));
