...
import com.tianzhu.identity.uaa.oauth.client.SecretChangeRequest;
import com.tianzhu.identity.uaa.resources.QueryableResourceManager;
import com.tianzhu.identity.uaa.resources.ResourceMonitor;
...
import com.tianzhu.identity.uaa.security.StubSecurityContextAccessor;
...
public class ClientAdminEndpointsTests {
    ...
    public void setUp() throws Exception {
        ...
        when(clientDetailsService.create(ArgumentMatchers.any(ClientDetails.class), ArgumentMatchers.anyString())).thenCallRealMethod();
    ...
    public void testCreateClientDetails() throws Exception {
        when(clientDetailsService.retrieve(ArgumentMatchers.anyString(), ArgumentMatchers.anyString())).thenReturn(input);
    ...
    public void testFindClientDetails_Test_Attribute_Filter() throws Exception {
        when(clientDetailsService.query(ArgumentMatchers.anyString(), ArgumentMatchers.anyString(), ArgumentMatchers.anyBoolean(), eq(IdentityZoneHolder.get().getId()))).thenReturn(Arrays.asList(inputs));
    ...
    public void testChangeSecret() throws Exception {
        ...
        when(authenticationManager.authenticate(ArgumentMatchers.any(Authentication.class))).thenReturn(auth);
    ...
    public void testChangeSecretDeniedWhenOldSecretNotProvided() throws Exception {
        ...
        when(authenticationManager.authenticate(ArgumentMatchers.any(Authentication.class))).thenThrow(new BadCredentialsException(""));
    ...
    public void testCreateClientWithAutoapproveScopesList() throws Exception {
        ...
        verify(clientDetailsService).create(clientCaptor.capture(), ArgumentMatchers.anyString());
    ...
    public void testUpdateClientWithAutoapproveScopesList() throws Exception {
        ...
        assertNull(result.getClientSecret());
        ArgumentCaptor<BaseClientDetails> clientCaptor = ArgumentCaptor.forClass(BaseClientDetails.class);
        verify(clientRegistrationService).updateClientDetails(clientCaptor.capture(), ArgumentMatchers.anyString());
