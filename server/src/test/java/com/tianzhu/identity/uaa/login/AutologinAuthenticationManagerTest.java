...
import com.tianzhu.identity.uaa.authentication.manager.AutologinAuthenticationManager;
...
public class AutologinAuthenticationManagerTest {
    ...
    public void authentication_successful() throws Exception {
        ...
        when(clientDetailsService.loadClientByClientId(ArgumentMatchers.eq(clientId), anyString())).thenReturn(new BaseClientDetails("test-client-details","","","",""));
        String zoneId = IdentityZoneHolder.get().getId();
        when(userDatabase.retrieveUserById(ArgumentMatchers.eq("test-user-id")))
            .thenReturn(
