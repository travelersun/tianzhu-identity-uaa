...
package com.tianzhu.identity.uaa.oauth.expression;
...
import com.tianzhu.identity.uaa.security.IsSelfCheck;
...
public class IsSelfCheckTest {
    ...
    public void ensure_revoke_self_detects_client_vs_user() {
        ...
        when(tokenProvisioning.retrieve(ArgumentMatchers.eq(revocableUserToken.getTokenId()), ArgumentMatchers.eq(IdentityZoneHolder.get().getId()))).thenReturn(revocableUserToken);
