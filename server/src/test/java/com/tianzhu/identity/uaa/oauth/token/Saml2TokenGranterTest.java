...
import com.tianzhu.identity.uaa.oauth.DisallowedIdpException;
...
import static com.tianzhu.identity.uaa.oauth.token.TokenConstants.USER_TOKEN_REQUESTING_CLIENT_ID;
...
public class Saml2TokenGranterTest {
    ...
    public void setup() {
        ...
        when(clientDetailsService.loadClientByClientId(ArgumentMatchers.eq(requestingClient.getClientId()), ArgumentMatchers.anyString())).thenReturn(requestingClient);
        when(clientDetailsService.loadClientByClientId(ArgumentMatchers.eq(receivingClient.getClientId()), ArgumentMatchers.anyString())).thenReturn(receivingClient);
    ...
    public void test_oauth2_authentication_with_invalid_allowed_provider() {
        ...
        when(uaaUserDatabase.retrieveUserById(ArgumentMatchers.anyString())).thenReturn(user);
