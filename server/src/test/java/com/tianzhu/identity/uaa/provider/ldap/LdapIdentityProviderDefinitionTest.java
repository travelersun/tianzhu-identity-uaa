...
import com.tianzhu.identity.uaa.impl.config.YamlMapFactoryBean;
import com.tianzhu.identity.uaa.impl.config.YamlProcessor;
import com.tianzhu.identity.uaa.provider.LdapIdentityProviderDefinition;
import com.tianzhu.identity.uaa.util.JsonUtils;
import com.tianzhu.identity.uaa.util.LdapUtils;
import com.tianzhu.identity.uaa.util.UaaMapUtils;
...
import static com.tianzhu.identity.uaa.provider.LdapIdentityProviderDefinition.*;
...
public class LdapIdentityProviderDefinitionTest {
    ...
    public void test_Search_and_Compare_Config() throws Exception {
        String config = "ldap:\n" +
            ...
            "    passwordEncoder: com.tianzhu.identity.uaa.provider.ldap.DynamicPasswordComparator\n" +
        ...
        assertEquals("com.tianzhu.identity.uaa.provider.ldap.DynamicPasswordComparator", def.getPasswordEncoder());
        assertNull(def.getGroupSearchBase());
        assertNull(def.getGroupSearchFilter());
        assertNull(def.getLdapGroupFile());
        assertTrue(def.isGroupSearchSubTree());
    ...
    public void deserialize_unknown_comparator_throws_error() throws Exception {
        String config = "ldap:\n" +
            ...
            "    searchFilter: 'cn={0}'\n" +
            "    passwordAttributeName: userPassword\n" +
            "    passwordEncoder: com.tianzhu.identity.uaa.provider.ldap.DynamicPasswordComparator1\n" +
            "    localPasswordCompare: true\n"+
            "    mailSubstitute: 'generated-{0}@company.example.com'\n" +
            "    mailSubstituteOverridesLdap: true\n";
