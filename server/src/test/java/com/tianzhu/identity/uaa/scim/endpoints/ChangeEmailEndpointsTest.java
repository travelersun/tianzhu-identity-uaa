...
public class ChangeEmailEndpointsTest extends TestClassNullifier {
    ...
    public void testGenerateEmailChangeCode() throws Exception {
        ...
        when(expiringCodeStore.generateCode(ArgumentMatchers.eq(data), ArgumentMatchers.any(Timestamp.class), ArgumentMatchers.eq(EMAIL.name()), ArgumentMatchers.eq(IdentityZoneHolder.get().getId())))
    ...
    public void testChangeEmail() throws Exception {
        ...
        verify(scimUserProvisioning).update(ArgumentMatchers.eq("user-id-001"), user.capture(), ArgumentMatchers.eq(IdentityZoneHolder.get().getId()));
