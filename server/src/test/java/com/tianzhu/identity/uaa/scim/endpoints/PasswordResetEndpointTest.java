...
import com.tianzhu.identity.uaa.account.PasswordResetEndpoint;
...
import static com.tianzhu.identity.uaa.codestore.ExpiringCodeType.AUTOLOGIN;
...
public class PasswordResetEndpointTest extends TestClassNullifier {
    ...
    public void setUp() throws Exception {
        ...
        when(expiringCodeStore.generateCode(ArgumentMatchers.eq(JsonUtils.writeValueAsString(change)), ArgumentMatchers.any(Timestamp.class), ArgumentMatchers.anyString(), ArgumentMatchers.anyString()))
    ...
    public void password_reset_with_client_id_and_redirect_uri() throws Exception {
        ...
        when(expiringCodeStore.generateCode(ArgumentMatchers.anyString(), ArgumentMatchers.any(Timestamp.class), ArgumentMatchers.anyString(), ArgumentMatchers.anyString()))
                .thenReturn(new ExpiringCode("secret_code", new Timestamp(System.currentTimeMillis() + UaaResetPasswordService.PASSWORD_RESET_LIFETIME), JsonUtils.writeValueAsString(change), null));
        ...
        verify(expiringCodeStore).generateCode(ArgumentMatchers.eq(JsonUtils.writeValueAsString(change)), ArgumentMatchers.any(Timestamp.class), ArgumentMatchers.anyString(), ArgumentMatchers.anyString());
    }
    ...
    public void password_reset_without_client_id_and_without_redirect_uri() throws Exception {
        ...
        when(expiringCodeStore.generateCode(ArgumentMatchers.anyString(), ArgumentMatchers.any(Timestamp.class), ArgumentMatchers.eq(null), ArgumentMatchers.anyString()))
                .thenReturn(new ExpiringCode("secret_code", new Timestamp(System.currentTimeMillis() + UaaResetPasswordService.PASSWORD_RESET_LIFETIME), JsonUtils.writeValueAsString(change), null));
    ...
    public void testChangingAPasswordWithAValidCode() throws Exception {
        ...
        when(expiringCodeStore.generateCode(ArgumentMatchers.anyString(), ArgumentMatchers.any(Timestamp.class), ArgumentMatchers.eq(AUTOLOGIN.name()), ArgumentMatchers.anyString())).thenReturn(autologinCode);
