...
public class UserIdConversionEndpointsTests {
    ...
    public void init() {
        ...
        when(provisioning.retrieveActive(ArgumentMatchers.anyString())).thenReturn(Collections.singletonList(MultitenancyFixture.identityProvider("test-origin", "uaa")));
    ...
    public void noActiveIdps_ReturnsEmptyResources() throws Exception {
        when(provisioning.retrieveActive(ArgumentMatchers.anyString())).thenReturn(Collections.emptyList());
