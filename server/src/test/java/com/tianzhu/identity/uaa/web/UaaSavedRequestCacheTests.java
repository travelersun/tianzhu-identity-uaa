...
import com.tianzhu.identity.uaa.web.UaaSavedRequestCache.ClientRedirectSavedRequest;
...
public class UaaSavedRequestCacheTests {
    ...
    public void filter_saves_when_needed() throws Exception {
        ...
        verify(spy, times(1)).saveClientRedirect(ArgumentMatchers.anyObject(), ArgumentMatchers.anyString());
