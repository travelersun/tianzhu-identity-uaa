...
public class ScimUserIds extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.antMatcher("/ids/Users*").
                ...
                .antMatchers("/**").access("scope=scim.userids")
                .and()
                .addFilterAt(idsResourceAuthenticationFilter,AbstractPreAuthenticatedProcessingFilter.class)
