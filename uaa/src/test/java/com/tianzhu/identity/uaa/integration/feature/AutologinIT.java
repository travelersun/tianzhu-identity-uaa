...
public class AutologinIT {
    ...
    public void testSimpleAutologinFlow() throws Exception {
        ...
        ResponseEntity<String> loginResponse = template.exchange(baseUrl + "/login",
                                                                 HttpMethod.GET,
                                                                 new HttpEntity<>(null, IntegrationTestUtils.getHeaders(cookieStore)),
                                                                 String.class);
        ...
        loginResponse = restOperations.exchange(baseUrl + "/login.do",
                                                HttpMethod.POST,
                                                new HttpEntity<>(requestBody, IntegrationTestUtils.getHeaders(cookieStore)),
                                                String.class);
        ...
        ResponseEntity<String> profilePage =
            restOperations.exchange(baseUrl + "/profile",
                                    HttpMethod.GET,
                                    new HttpEntity<>(null, IntegrationTestUtils.getHeaders(cookieStore)), String.class);
