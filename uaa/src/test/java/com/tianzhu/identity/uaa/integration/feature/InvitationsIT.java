...
import static com.tianzhu.identity.uaa.integration.util.IntegrationTestUtils.getZoneAdminToken;
...
public class InvitationsIT {
    ...
    public void invitedOIDCUserVerified() throws Exception {
        ...
        IntegrationTestUtils.deleteProvider(IntegrationTestUtils.getZoneAdminToken(baseUrl, serverRunning), baseUrl, "uaa", "puppy-invite");
    }
