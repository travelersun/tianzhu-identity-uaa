...
import com.tianzhu.identity.uaa.account.ResetPasswordController;
...
import com.tianzhu.identity.uaa.provider.saml.BootstrapSamlIdentityProviderConfigurator;
import com.tianzhu.identity.uaa.provider.saml.LoginSamlEntryPoint;
import com.tianzhu.identity.uaa.provider.saml.SamlSessionStorageFactory;
import com.tianzhu.identity.uaa.provider.saml.ZoneAwareMetadataGenerator;
...
import com.tianzhu.identity.uaa.user.JdbcUaaUserDatabase;
import com.tianzhu.identity.uaa.user.UaaUser;
import com.tianzhu.identity.uaa.util.CachingPasswordEncoder;
...
import static com.tianzhu.identity.uaa.provider.ExternalIdentityProviderDefinition.FAMILY_NAME_ATTRIBUTE_NAME;
import static com.tianzhu.identity.uaa.provider.ExternalIdentityProviderDefinition.GIVEN_NAME_ATTRIBUTE_NAME;
