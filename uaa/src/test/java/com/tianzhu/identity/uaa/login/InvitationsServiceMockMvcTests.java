...
public class InvitationsServiceMockMvcTests extends InjectedMockContextTest {
    ...
    public MockMvcUtils.ZoneScimInviteData createZoneForInvites() throws Exception {
        return MockMvcUtils.utils().createZoneForInvites(getMockMvc(), getWebApplicationContext(), clientId, REDIRECT_URI);
    }
    ...
    public void test_authorize_with_invitation_login() throws Exception {
        ...
        String adminToken = MockMvcUtils.utils().getClientCredentialsOAuthAccessToken(getMockMvc(), "admin", "adminsecret", "", null);
    ...
    public void invite_ldap_users_verifies_and_redirects() throws Exception {
        MockMvcUtils.ZoneScimInviteData zone = createZoneForInvites();
    ...
    protected IdentityProvider createIdentityProvider(MockMvcUtils.IdentityZoneCreationResult zone, String nameAndOriginKey, AbstractIdentityProviderDefinition definition) throws Exception {
        return MockMvcUtils.utils().createIdentityProvider(getMockMvc(), zone, nameAndOriginKey, definition);
    }

    protected SamlIdentityProviderDefinition getSamlIdentityProviderDefinition(MockMvcUtils.IdentityZoneCreationResult zone, String entityID) {
    ...
    public URL inviteUser(String email, String userInviteToken, String subdomain, String clientId, String expectedOrigin) throws Exception {
        return MockMvcUtils.utils().inviteUser(getWebApplicationContext(), getMockMvc(), email, userInviteToken, subdomain, clientId, expectedOrigin,REDIRECT_URI);
    }

    private String extractInvitationCode(String inviteLink) throws Exception {
        return MockMvcUtils.utils().extractInvitationCode(inviteLink);
    }
