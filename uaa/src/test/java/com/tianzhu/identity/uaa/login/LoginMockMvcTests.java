...
import static com.tianzhu.identity.uaa.mock.util.MockMvcUtils.createOtherIdentityZone;
import static com.tianzhu.identity.uaa.mock.util.MockMvcUtils.getUaaSecurityContext;
...
import static com.tianzhu.identity.uaa.zone.IdentityZone.getUaa;
...
public class LoginMockMvcTests extends InjectedMockContextTest {
    ...
    public void global_zone_variable_home_redirect() throws Exception {
        ...
        getMockMvc().perform(
            get("/")
                .with(securityContext(MockMvcUtils.getUaaSecurityContext(marissa.getUserName(), getWebApplicationContext(), zone)))
                .header("Host", zone.getSubdomain()+".localhost")
        )
            .andDo(print())
            .andExpect(status().isOk());
    ...
    private IdentityZone setupZone(IdentityZoneConfiguration config) throws Exception {
        ...
        IdentityZone zone = MockMvcUtils.createOtherIdentityZone(zoneId, getMockMvc(), getWebApplicationContext(), false);
