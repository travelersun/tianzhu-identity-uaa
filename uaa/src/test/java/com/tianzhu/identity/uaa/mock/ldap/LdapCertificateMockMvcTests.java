...
public class LdapCertificateMockMvcTests extends InjectedMockContextTest {
    ...
    public void createzones() throws Exception {
        trustedCertZone = MockMvcUtils.utils().createOtherIdentityZoneAndReturnResult(
            gen.generate(),
            getMockMvc(),
        ...
        trustedButExpiredCertZone = MockMvcUtils.utils().createOtherIdentityZoneAndReturnResult(
            gen.generate(),
            getMockMvc(),
            getWebApplicationContext(),
            null);
