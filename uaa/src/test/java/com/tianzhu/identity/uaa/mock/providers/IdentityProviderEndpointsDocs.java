 ...
 *******************************************************************************/
package com.tianzhu.identity.uaa.mock.providers;
...
public class IdentityProviderEndpointsDocs extends InjectedMockContextTest {
    ...
    private final FieldDescriptor LDAP_USER_COMPARE_ENCODER = fieldWithPath("config.passwordEncoder").optional("com.tianzhu.identity.uaa.provider.ldap.DynamicPasswordComparator").type(STRING).description("Used with `search-and-compare` only. A fully-qualified Java classname to the password encoder. This encoder is used to properly encode user password to match the one in the LDAP directory.");
