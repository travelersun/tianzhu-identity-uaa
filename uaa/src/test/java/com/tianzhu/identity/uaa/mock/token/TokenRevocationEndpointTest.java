...
public class TokenRevocationEndpointTest extends AbstractTokenMockMvcTests {
    ...
    private void revokeUserClientCombinationTokenWithAuth(String token) throws Exception{
        ...
        String client1UserToken = MockMvcUtils.getUserOAuthAccessToken(
                getMockMvc(),
                client.getClientId(),
                client.getClientSecret(),
                user1.getUserName(),
        ...
        String client2UserToken = MockMvcUtils.getUserOAuthAccessToken(
                getMockMvc(),
                otherClient.getClientId(),
                otherClient.getClientSecret(),
                user1.getUserName(),
        ...
        String client1DifferentUserToken = MockMvcUtils.getUserOAuthAccessToken(
                getMockMvc(),
                client.getClientId(),
                client.getClientSecret(),
                user2.getUserName(),
