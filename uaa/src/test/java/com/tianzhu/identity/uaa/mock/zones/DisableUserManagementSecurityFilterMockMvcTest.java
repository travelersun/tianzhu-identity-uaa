...
import com.tianzhu.identity.uaa.scim.endpoints.PasswordChange;
...
public class DisableUserManagementSecurityFilterMockMvcTest extends InjectedMockContextTest {
    ...
    private MockMvcUtils.CookieCsrfPostProcessor cookieCsrf() {
        return new MockMvcUtils.CookieCsrfPostProcessor();
    }
