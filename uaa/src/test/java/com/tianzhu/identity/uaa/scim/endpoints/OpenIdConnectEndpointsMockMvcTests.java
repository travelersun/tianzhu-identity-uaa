...
import com.tianzhu.identity.uaa.account.OpenIdConfiguration;
...
public class OpenIdConnectEndpointsMockMvcTests extends InjectedMockContextTest {
    ...
    public void setUp() throws Exception {
        identityZone = MockMvcUtils.createOtherIdentityZone("subdomain", getMockMvc(), getWebApplicationContext());
    }
